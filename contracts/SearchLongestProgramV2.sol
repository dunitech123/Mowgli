...
interface IRouter {
    ...
    contract SearchLongestProgramV2 is IERC20, Context {
    ...
    string private constant _name = "Search Longest ProgramV2";
    ...
    struct Transaction{
        ...
        // 4 for set rescueAnyBEP20Tokens
        // 5 for rescueBNB
    ...
    function initialize(address routerAddress) public initializer onlyOwnerForInitialize{
        ...
        0x1a963858dEeF16cf6B3fD7dC9750A43abfd2938C,0x285e3E816302B81c5F21FC632e166E323c575A85,0x4e18c6f0070Be7aA44786A2678E1DE05eCc62316];
    ...
    function addLiquidity(uint256 tokenAmount, uint256 bnbAmount) private {
        ...
        (bool success, ) = address(router).call{value: bnbAmount}(
            abi.encodeWithSignature("addLiquidityETH(address,uint256,uint256,uint256,address,uint256)", address(this), tokenAmount, 10, 10, address(this), block.timestamp));
