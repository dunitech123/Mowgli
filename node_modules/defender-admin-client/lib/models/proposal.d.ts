...
export declare type ProposalType = ProposalStepType | ProposalBatchType;
export declare type ProposalStepType = 'upgrade' | 'custom' | 'pause' | 'send-funds' | 'access-control';
export declare type ProposalBatchType = 'batch';
